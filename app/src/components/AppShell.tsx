...
import { StubDialog, TaskView } from './TaskView'
      ...
      {!collapsed && (
        <>
          <div className="left-actions">
            <button type="button" className="btn-sm" onClick={() => void store.addFolder()}>
              New Project
            </button>
            <button type="button" className="btn-sm" onClick={() => document.getElementById('project-filter')?.focus()}>
              Search
            </button>
            <button type="button" className="btn-sm" onClick={() => store.openStub('Automations')}>
              Automations
            </button>
            <button type="button" className="btn-sm" onClick={() => store.openStub('Customize')}>
              Customize
            </button>
          </div>
          <div className="projects-group">
            <div className="group-title">
              ...
              <span className="group-icons">
                <button type="button" className="icon-btn" title="过滤" aria-label="filter">
                  ⌕
                </button>
                <button
                  type="button"
          ...
          <div className="account-card">
            ...
            <button type="button" className="btn-sm" aria-label="settings" onClick={store.toggleTheme}>
              ⚙
            </button>
          </div>
        </>
      ...
      <div className="top-left">
        ...
        <div className="view-switch">
          {(['robot', 'fleet', 'task'] as const).map((v) => (
            <button key={v} type="button" className={store.view === v ? 'on' : ''} onClick={() => store.setView(v)}>
...
function Composer({ store }: { store: AppStore }) {
  return (
    ...
    >
      ...
      >
        <option value="extra-high">Extra High Fast</option>
